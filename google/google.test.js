...
test('I can search Google', async () => {
    ...
    //let searchText = await driver.findElement(By.xpath('//input[@name="q"]')).getAttribute("value");
    let searchText = await driver.findElement(By.name('q')).getAttribute("value");

    expect(searchText).toContain('parks');
})